...
### ⚠️ Invariant 13: Anchor bodies are rendered as variables on every run
...
### Bug Pattern AA: Pending execution path ends without a helper write → pending stuck until midnight
