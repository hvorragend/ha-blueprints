...
| Debugging a regression, changing global conditions / trigger `enabled:` / helper-JSON regexes / flow handoffs | [references/bug-patterns.md](references/bug-patterns.md) (patterns A–AY with cause and fix) |
...
(A–AY, each with symptom / cause / fix / derived rule) before writing a fix —
