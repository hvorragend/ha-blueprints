...
**Known residual window of that asymmetry (documented 2026.07.20, accepted):** a shading-**end**
...
The same source was also missing from the "no trigger source at all" configuration error (config check + online validator, added 2026.07.20): a resident-driven setup **has** a trigger source and must not be flagged.
