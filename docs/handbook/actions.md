...
*Blueprint input: `auto_up_action_before`*
...
*Blueprint input: `auto_up_action`*
...
*Blueprint input: `auto_down_action_before`*
...
*Blueprint input: `auto_down_action`*
...
*Blueprint input: `auto_ventilate_action_before`*
...
*Blueprint input: `auto_ventilate_action`*
...
*Blueprint input: `auto_shading_start_action_before`*
...
*Blueprint input: `auto_shading_start_action`*
...
*Blueprint input: `auto_shading_end_action_before`*
...
*Blueprint input: `auto_shading_end_action`*
...
*Blueprint input: `auto_manual_action`*
...
*Blueprint input: `auto_override_reset_action`*
