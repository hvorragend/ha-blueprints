...
*Blueprint input: `drive_delay_fix`* *(default: `0`)*

Fixed drive delay to avoid radio interferences. <br /><br />`Optional`

<a id="drive_delay_random"></a>

## 🕛 Random Drive Delay

*Blueprint input: `drive_delay_random`* *(default: `5`)*

Additional random delay. <br /><br />`Optional`
